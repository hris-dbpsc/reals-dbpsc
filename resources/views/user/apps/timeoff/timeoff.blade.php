            ...
            <main>
                ...
                <div class="container-fluid px-4 mt-n10">
                    <div class="row">
                        ...
                        <div class="col-xl-3 mb-2">
                            <!-- CARD 2-->
                            <a class="card lift lift-sm h-100" href="{{ route('user_alltimeoff') }}?status=all">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                        ...
                        <div class="col-xl-3 mb-2">
                            <!-- CARD 3-->
                            <a class="card lift lift-sm h-100" href="{{route('user_alltimeoff') }}?status=pending">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                        ...
                        <div class="col-xl-3 mb-2">
                            <!-- CARD 4-->
                            <a class="card lift lift-sm h-100" href="{{route('user_alltimeoff')}}?status=approved">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
