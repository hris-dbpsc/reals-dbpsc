                            ...
                            <div class="row align-items-center justify-content-between pt-3">
                                <div class="col-auto mb-3">
                                    <h1 class="page-header-title text-body d-flex align-items-center">
                                        <a href="{{ route('user_dashboard') }}" class="btn rounded-circle shadow-sm d-flex align-items-center justify-content-center me-2" style="width:50px; height:50px; padding:0;">
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-2 mb-xl-0">
                                ...
                                <div class="card-body text-center">
                                    <form action="{{ route('user_uploadprofilepicture', encrypt(Auth::guard('user')->user()->id)) }}" method="POST" enctype="multipart/form-data" id="profilePhotoForm">
                                        @csrf
                                        @method('PUT')
                                        
                                        <!-- Profile picture image with cropping/zoom -->
                                        <div class="position-relative d-flex flex-column align-items-center mb-2">
                                            <img id="profilePhotoPreview" class="img-account-profile rounded-circle mb-2"
                                                src="{{ file_exists(public_path('assets/users/users/' . Auth::guard('user')->user()->employeenumber . '.jpg')) ? asset('assets/users/users/' . Auth::guard('user')->user()->employeenumber . '.jpg') : asset('assets/assets/img/demo/user-placeholder.svg') }}"
                                                alt="Profile Photo"
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('user_profile', encrypt(Auth::guard('user')->user()->id)) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <!-- Form Row-->
                                        <div class="row gx-3 mb-2">
                                            <div class="col-md-12">
                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="employeenumber" name="employeenumber" type="text" placeholder="Employee Number" value="{{ Auth::guard('user')->user()->employeenumber }}" readonly />
                                                    <label for="employeenumber">Employee Number</label>
                                                </div>

                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="firstname" name="firstname" type="text" placeholder="First Name" value="{{ Auth::guard('user')->user()->firstname }}" readonly />
                                                    <label for="firstname">First Name</label>
                                                </div>

                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="middlename" name="middlename" type="text" placeholder="Middle Name" value="{{ Auth::guard('user')->user()->middlename }}" readonly />
                                                    <label for="middlename">Middle Name</label>
                                                </div>

                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="lastname" name="lastname" type="text" placeholder="Last Name" value="{{ Auth::guard('user')->user()->lastname }}" readonly />
                                                    <label for="lastname">Last Name</label>
                                                </div>

                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="email" name="email" type="text" placeholder="Email" value="{{ Auth::guard('user')->user()->email }}" readonly />
                                                    <label for="email">Email</label>
                                                </div>

                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="contact" name="contact" type="text" placeholder="Contact Number" value="{{ Auth::guard('user')->user()->contact }}" readonly />
                            ...
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('user_changepassword', encrypt(Auth::guard('user')->user()->id)) }}" method="POST">
                                        @csrf
