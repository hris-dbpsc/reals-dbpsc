                                            ...
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-12">
                                                    <div class="form-floating mb-2">
                                                        <select class="form-select" id="clientname" name="clientname" disabled>
                                                            @foreach($clients as $client)
                                                                <option value="{{ $client->id }}" {{ $clientadmin->clientid == $client->id ? 'selected' : '' }}>
                                                                    {{ $client->clientname }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" id="email" name="email" type="text" value="{{ $clientadmin->email }}" placeholder="Email" readonly/>
