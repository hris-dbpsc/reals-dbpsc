                                        ...
                                        <div class="row gx-3 mb-2">
                                            ...
                                            <div class="col-md-3 form-floating">
                                                <select class="form-select" name="role" id="role" required>
                                                    ...
                                                    <option value="areacoordinator">Area Coordinator</option>
                                                </select>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        ...
                                                        <button type="submit" class="btn btn-outline-primary" id="addAdminBtn" onclick="disableAddAdminBtn(this)">
                                                            <i class="me-1" data-feather="plus"></i>Add Admin
                                                        </button>
                                                        <script>
                                                            function disableAddAdminBtn(btn) {
                                                                btn.disabled = true;
