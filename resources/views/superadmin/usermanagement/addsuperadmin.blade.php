        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4 mt-2">
                    <div class="row">
                        <div class="col-xl-12">
                            <!-- Superadmin details card-->
                            <div class="card mb-2">
                                <div class="card-header text-body">Superadmin Information</div>
                                <div class="card-body">
                                    <form action="{{ route('superadmin_addsuperadmin_submit')}}" method="POST">
                                        @csrf
                                        <!-- Form Row-->
                                        ...
                                        <div class="d-grid d-md-block">
                                            ...
                                            <!-- Confirmation Modal -->
                                            <div class="modal fade" id="confirmAddSuperadminModal" tabindex="-1" aria-labelledby="confirmAddSuperadminModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="confirmAddSuperadminModalLabel">Confirm Add Superadmin</h5>
                                                        ...
                                                        <div class="modal-footer justify-content-center">
                                                            ...
                                                            <button type="submit" class="btn btn-outline-primary" id="addSuperadminBtn" onclick="disableAddSuperadminBtn(this)">
                                                                <i class="me-1" data-feather="plus"></i>Add Superadmin
                                                            </button>
                                                            <script>
                                                                function disableAddSuperadminBtn(btn) {
                                                                    btn.disabled = true;
