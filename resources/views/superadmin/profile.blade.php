                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-2 mb-xl-0">
                                ...
                                <div class="card-body text-center">
                                    <form action="{{ route('profile_uploadprofilepicture', Auth::guard('superadmin')->user()->id) }}" method="POST" enctype="multipart/form-data" id="profilePhotoForm">
                                        @csrf
                                        @method('PUT')
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('profile', Auth::guard('superadmin')->user()->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <!-- Form Row-->
                            ...
                            <div class="card mb-2">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('changepassword', Auth::guard('superadmin')->user()->id) }}" method="POST">
                                        @csrf
                                        <div class="modal-body">
