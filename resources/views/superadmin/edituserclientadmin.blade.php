                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card mb-4 mb-xl-0">
                            ...
                            <div class="card-body text-center">
                                ...
                                <img class="img-account-profile image rounded-circle mb-2" style="width: 180px; height: 180px; object-fit: cover;" src="{{ $clientadmin->photo ? asset('assets/users/clientadmin/' . $clientadmin->photo) : asset('assets/assets/img/illustrations/profiles/profile-1.png') }}" alt="Profile Photo" />
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3 text-center">
                                                <span class="badge bg-success" style="font-size: 1rem;">
                                                    {{ ucfirst($clientadmin->role ?? 'Admin') }}
                                                </span>
                                            </div>
