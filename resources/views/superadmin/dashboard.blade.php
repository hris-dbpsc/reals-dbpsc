                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
                                            ...
                                            <div class="text-lg fw-bold">{{ $totalActive }}</div>
                                        </div>
                                        <i class="feather-xl text-white-50" data-feather="users"></i>
                                    </div>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-white stretched-link" href="{{ route('superadmin_usermanagement') }}">User Management</a>
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-warning text-white h-100">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-white stretched-link" href="{{ route('superadmin_clientmanagement') }}">Client Management</a>
                                    <div class="text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-success text-white h-100">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-white stretched-link" href="{{ route('superadmin_apps') }}">View Applications</a>
                                    <div class="text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-danger text-white h-100">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-white stretched-link" href="{{ route('superadmin_apps') }}">View Requests</a>
                                    <div class="text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-footer position-relative">
                                    <a class="stretched-link" href="{{ route('superadmin_watsonsworkforce') }}">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-footer position-relative">
                                    <a class="stretched-link" href="{{ route('superadmin_timeoff') }}">
                                        <div class="text-xs d-flex align-items-center justify-content-between">
                                            View More Data
                                            <i class="fas fa-long-arrow-alt-right"></i>
                                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-xl-2 mb-2">
                                    ...
                                    <a class="card lift h-100" href="{{ route('superadmin_people') }}">
                                ...
                                <div class="col-xl-2 mb-2">
                                    <!-- Dashboard example card 1-->
                                    <a class="card lift h-100" href="{{ route('superadmin_watsonsworkforce') }}">
                                        <div class="card-body d-flex justify-content-center flex-column">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="me-3">
                                ...
                                <div class="col-xl-2 mb-2">
                                    <!-- Dashboard example card 1-->
                                    <a class="card lift h-100" href="{{ route('superadmin_timeoff') }}">
                                        <div class="card-body d-flex justify-content-center flex-column">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="me-3">
                                ...
                                <div class="col-xl-2 mb-2">
                                    <!-- Dashboard example card 1-->
                                    <a class="card lift h-100" href="{{ route('superadmin_locator') }}">
                                        <div class="card-body d-flex justify-content-center flex-column">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="me-3">
                                ...
                                <div class="col-xl-2 mb-2">
                                    <!-- Dashboard example card 1-->
                                    <a class="card lift h-100" href="{{ route('superadmin_timelog') }}">
                                        <div class="card-body d-flex justify-content-center flex-column">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="me-3">
                                ...
                                <div class="col-xxl-4">
                                    <div class="row">
                                        <div class="col-xl-6 col-xxl-12">
                                            ...
                                            <div class="card mb-4">
                                                <div class="card-header">Superadmins</div>
                                                <div class="card-body">
                                                    <!-- Item 1-->
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                                            <div class="d-flex align-items-center flex-shrink-0 me-3">
                                                                <div class="avatar avatar-xl me-3 bg-gray-200">
                                                                    @if($superadmin->photo)
                                                                        <img class="avatar-img img-fluid" src="{{ asset('assets/users/superadmin/' . $superadmin->photo) }}" alt="" />
                                                                    @else
                                                                        <img class="avatar-img img-fluid" src="{{ asset('assets/assets/img/demo/user-placeholder.svg') }}" alt="" />
                                                                    @endif
                                                                </div>
                                                                <div class="d-flex flex-column fw-bold">
                                                                    <a class="text-dark line-height-normal mb-1" href="#!">{{ $superadmin->firstname }} {{ $superadmin->lastname }}</a>
                                                                    <div class="small text-muted line-height-normal">{{ $superadmin->role ?? 'Superadmin' }}</div>
                                                                </div>
                                                            </div>
                                                            <div class="dropdown no-caret">
                                                                <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownPeople{{ $loop->index }}" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                    <i data-feather="more-vertical"></i>
                                                                </button>
                                                                <div class="dropdown-menu dropdown-menu-end animated--fade-in-up" aria-labelledby="dropdownPeople{{ $loop->index }}">
                                                                    <a class="dropdown-item" href="{{ route('superadmin_editusersuperadmin', ['id' => $superadmin->id]) }}">edit user</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @foreach($activeAdmins as $admin)
                                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                                            ...
                                                            <div class="dropdown no-caret">
                                                                <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownPeopleAdmin{{ $loop->index }}" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                    <i data-feather="more-vertical"></i>
                                                                </button>
                                                                <div class="dropdown-menu dropdown-menu-end animated--fade-in-up" aria-labelledby="dropdownPeopleAdmin{{ $loop->index }}">
                                                                    <a class="dropdown-item" href="{{ route('superadmin_edituseradmin', ['id' => $admin->id]) }}">edit user</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @foreach($activeClientadmins as $clientadmin)
                                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                                            ...
                                                            <div class="dropdown no-caret">
                                                                <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownPeopleClientAdmin{{ $loop->index }}" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                    <i data-feather="more-vertical"></i>
                                                                </button>
                                                                <div class="dropdown-menu dropdown-menu-end animated--fade-in-up" aria-labelledby="dropdownPeopleClientAdmin{{ $loop->index }}">
                                                                    <a class="dropdown-item" href="{{ route('superadmin_edituserclientadmin', ['id' => $clientadmin->id]) }}">edit user</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
