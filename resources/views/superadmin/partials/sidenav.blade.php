        ...
        <div class="sidenav-menu">
            <div class="nav accordion" id="accordionSidenav">
                ...
                <div class="collapse" id="viewapps" data-bs-parent="#accordionSidenavPagesMenu">
                    <nav class="sidenav-menu-nested nav">
                        <!-- Sidenav Link (Charts)-->
                        <a class="nav-link" href="{{ route('superadmin_people') }}">
                            <div class="nav-link-icon"><i data-feather="user"></i></div>
                            People
                        </a>
                        <!-- Sidenav Link (Tables)-->
                        <a class="nav-link" href="{{ route('superadmin_watsonsworkforce') }}">
                            <div class="nav-link-icon"><i data-feather="users"></i></div>
                            WorkForce
                        </a>
                        </a>
                        <!-- Sidenav Link (Tables)-->
                        <a class="nav-link" href="{{ route('superadmin_timeoff') }}">
                            <div class="nav-link-icon"><i data-feather="calendar"></i></div>
                            TimeOff
                        </a>
                        </a>
                        <!-- Sidenav Link (Tables)-->
                        <a class="nav-link" href="{{ route('superadmin_locator') }}">
                            <div class="nav-link-icon"><i data-feather="map-pin"></i></div>
                            Locator
                        </a>
                        <!-- Sidenav Link (Tables)-->
                        <a class="nav-link" href="{{ route('superadmin_timelog') }}">
