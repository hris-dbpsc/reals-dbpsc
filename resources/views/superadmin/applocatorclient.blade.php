...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main>
                    ...
                    <div class="page-header-content pt-4">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-auto mt-4">
                                ...
                                <div class="page-header-subtitle animate__animated animate__zoomIn text-muted mt-2">A Geographic Information System Application</div>
                            </div>
                        ...
                        <a class="card lift h-100 shadow-lg border-0 position-relative" href="javascript:void(0);" id="viewAllClientsBtn" onmouseover="highlightCard(this)" onmouseout="resetCard(this)">
                            <div class="card-body d-flex justify-content-center flex-column">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="me-3">
                                        <i class="feather text-primary mb-1 animate__animated animate__zoomIn" data-feather="list" style="width: 64px; height: 64px;"></i>
                                        <h3 class="fw-bold animate__animated animate__zoomIn">View All Clients</h3>
                            ...
                            <div class="card-body d-flex justify-content-center flex-column">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="me-3">
                                        ...
                                        <h3 class="fw-bold animate__animated animate__zoomIn">Search Client</h3>
                                        <div class="position-relative d-inline-block w-100">
                                            <div class="text-muted small mt-1 animate__animated animate__fadeInUp">Locate a Client</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- SEARCH CLIENT MAP -->
            <div class="container px-4" id="mapContainer2" style="display:none;">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-center align-items-center" style="height: 40px;">
                            <span id="selectedClientDisplay" class="badge bg-primary" style="font-size: 1.2rem; padding: 0.5rem 1rem;"></span>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <script>
                            ...
                            function initMap2() {
                                ...
                                for (let i = 0; i < locations2.length; i++) {
                                    ...
                                    let marker = new google.maps.Marker({
                                        position: { lat: locations2[i][1], lng: locations2[i][2] },
                                        map: map,
                                        icon: markerImage,
                                        url: locations2[i][4]
                                    });
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <button class="btn btn-xs btn-primary viewClientBtn" type="button" data-clientname="{{ $client->clientshortname }}" @if(is_null($client->clientgeolocation)) disabled @endif >
                    ...
                    function attachViewClientBtnListeners() {
                        document.querySelectorAll('.viewClientBtn').forEach(function(btn) {
                            btn.addEventListener('click', function() {
                                ...
                                setTimeout(function() { initMap2(); }, 100);
                            });
                        });
                    }
