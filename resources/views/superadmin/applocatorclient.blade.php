                    ...
                    <div class="card-header text-body">
                        <div class="d-flex justify-content-center align-items-center" style="height: 40px;">
                            <a id="selectedClientDisplay" class="btn btn-outline-primary" style="font-size: 1.5rem; padding: 0.5rem 1rem;"
                                onclick="if(this.textContent){window.open('{{ route('superadmin_applocatordata', ['client' => 'CLIENT_PLACEHOLDER']) }}'.replace('CLIENT_PLACEHOLDER', encodeURIComponent(this.textContent)), '_blank', 'toolbar=no,scrollbars=yes,resizable=no,location=no');} return false;"></a>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <button class="btn btn-outline-primary viewClientBtn" type="button" data-clientname="{{ $client->clientshortname }}" @if(is_null($client->clientgeolocation)) disabled @endif >
                    ...
                    function attachViewBranchBtnListenersClient() {
                        document.querySelectorAll('.viewBranchBtn').forEach(function(btn) {
                            btn.addEventListener('click', function() {
                                ...
                                setTimeout(function() { renderSingleBranchMapClient(geolocation, branchName, streetView); }, 100);
                    ...
                    function attachViewClientBtnListeners() {
                        document.querySelectorAll('.viewClientBtn').forEach(function(btn) {
                            btn.addEventListener('click', function() {
                                ...
                                document.getElementById('selectedClientDisplay').innerHTML ='<i data-feather="eye" class="me-2" style="width:1.5rem;height:1.5rem;"></i><span style="font-size:1.5rem;">'+ clientName +'</span>';
                                feather.replace();
                                setTimeout(function() {
                                    initMap2();
                                }, 100);
