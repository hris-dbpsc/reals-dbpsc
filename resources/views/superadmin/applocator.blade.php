                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-2">
                                    <h2 class="page-header-title text-body d-flex align-items-center" style="font-size:1.5rem;">
                                        ...
                                        <div class="page-header-subtitle text-dark mt-2">A Geographic Information System Application</div>
                                </div>
                ...
                <div class="container-fluid px-4 mt-n10">
                    <div class="row">
                        ...
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card lift h-100" href="{{ route('superadmin_applocatorbranch') }}">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                                            <i class="feather text-secondary mb-1" data-feather="list" style="width: 64px; height: 64px;"></i>
                                            <h3 class="fw-bold">Branch Locator</h3>
                                            <div class="position-relative d-inline-block w-100">
                        ...
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card lift h-100" href="{{ route('superadmin_applocatoremployee') }}">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                                            <i class="feather text-success mb-1" data-feather="users" style="width: 64px; height: 64px;"></i>
                                            <h3 class="fw-bold">Employee Locator</h3>
                                            <div class="position-relative d-inline-block w-100">
