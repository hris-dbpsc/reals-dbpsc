                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card mb-4 mb-xl-0">
                            ...
                            <div class="card-body text-center">
                                ...
                                <img class="img-account-profile image rounded-circle mb-2" style="width: 180px; height: 180px; object-fit: cover;" src="{{ $admin->photo ? asset('assets/users/admin/' . $admin->photo) : asset('assets/assets/img/illustrations/profiles/profile-1.png') }}" alt="Profile Photo" />
