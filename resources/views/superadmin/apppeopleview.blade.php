                            ...
                            <div class="card mb-2 mb-xl-0">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div style="position: relative; display: flex; justify-content: center; align-items: center; width: 200px; height: 200px; margin: auto;">
                                        ...
                                        <span style="position: absolute; bottom: 12px; right: 12px; width: 32px; height: 32px; {{ $user->isactive == 1 ? 'background:#28a745;' : 'background:#dc3545;' }} border: 2px solid #fff; border-radius: 50%; display: block;"></span>
                                    </div>
