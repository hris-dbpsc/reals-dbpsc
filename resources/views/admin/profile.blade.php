                            ...
                            <div class="row align-items-center justify-content-between pt-3">
                                <div class="col-auto mb-3">
                                    <h1 class="page-header-title text-body d-flex align-items-center">
                                        <a href="{{ route('admin_dashboard') }}" class="btn rounded-circle shadow-sm d-flex align-items-center justify-content-center me-2" style="width:50px; height:50px; padding:0;">
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-2 mb-xl-0">
                                ...
                                <div class="card-body text-center">
                                    <form action="{{ route('admin_uploadprofilepicture', encrypt(Auth::guard('admin')->user()->id)) }}" method="POST" enctype="multipart/form-data" id="profilePhotoForm">
                                        @csrf
                                        @method('PUT')
                                        <!-- Profile picture image with cropping/zoom -->
                                        <div class="position-relative d-flex flex-column align-items-center mb-2">
                                            <img id="profilePhotoPreview" class="img-account-profile rounded-circle mb-2" src="{{ Auth::guard('admin')->user()->photo ? asset('assets/users/admin/' . Auth::guard('admin')->user()->photo) : asset('assets/assets/img/demo/user-placeholder.svg') }}" alt="Profile Photo" style="object-fit: cover; width: 220px; height: 220px;" />
                                        ...
                                        <div class="row gx-3 mb-2">
                                            <div class="col-md-12">
                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="firstname" name="firstname" type="text" placeholder="First Name" value="{{ Auth::guard('admin')->user()->firstname }}" />
                                                    <label for="firstname">First Name</label>
                                                </div>

                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="middlename" name="middlename" type="text" placeholder="Middle Name" value="{{ Auth::guard('admin')->user()->middlename }}" />
                                                    <label for="middlename">Middle Name</label>
                                                </div>

                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="lastname" name="lastname" type="text" placeholder="Last Name" value="{{ Auth::guard('admin')->user()->lastname }}" />
                                                    <label for="lastname">Last Name</label>
                                                </div>

                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="email" name="email" type="text" placeholder="Email" value="{{ Auth::guard('admin')->user()->email }}" />
                                                    <label for="email">Email</label>
                                                </div>

                                                <div class="form-floating mb-2">
                                                    <input class="form-control" id="contact" name="contact" type="text" placeholder="Contact Number" value="{{ Auth::guard('admin')->user()->contact }}" />
