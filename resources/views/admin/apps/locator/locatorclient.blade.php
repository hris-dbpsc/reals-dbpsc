                        ...
                        <div class="card-header text-body">
                            <div class="d-flex justify-content-center align-items-center" style="height: 40px;">
                                <a id="selectedClientDisplay" class="btn btn-outline-primary" style="font-size: 1.5rem; padding: 0.5rem 1rem;"
                                    onclick="if(selectedClientId){window.open('{{ route('admin_locatordata', ['client' => 'CLIENT_PLACEHOLDER']) }}'.replace('CLIENT_PLACEHOLDER', encodeURIComponent(selectedClientId)), '_blank', 'toolbar=no,scrollbars=yes,resizable=no,location=no');} return false;">
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
