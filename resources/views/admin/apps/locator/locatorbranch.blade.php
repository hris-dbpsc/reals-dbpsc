                        ...
                        <div class="page-header-content pt-4">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto mt-4">
                                    <a href="{{ route('admin_locator') }}" class="btn btn-light rounded-circle shadow-sm d-flex align-items-center justify-content-center" style="width:50px; height:50px; padding:0;">
                                    ...
                                    <tr>
                                        <td>
                                            <div style="position: relative; display: flex; justify-content: center; align-items: center; width: 50px; height: 50px; margin: auto;">
                                                <img src="{{ $branch->clientphoto ? asset('assets/clients/' . $branch->clientphoto) : asset('assets/assets/img/demo/user-placeholder.svg') }}" alt="Photo" width="50" height="50" style="object-fit:cover; border-radius:50%; display:block; border: 2px solid #ccc;">
                        ...
                        <div class="card-header text-body">
                            <div class="d-flex justify-content-center align-items-center" style="height: 40px;">
                                <a id="perClientBranchesMapHeader" class="btn btn-outline-primary" style="font-size: 1.5rem; padding: 0.5rem 1rem;"
                                    onclick="if(window.selectedClientId){window.open('{{ route('admin_locatordata', ['client' => 'CLIENT_PLACEHOLDER']) }}'.replace('CLIENT_PLACEHOLDER', encodeURIComponent(window.selectedClientId)), '_blank', 'toolbar=no,scrollbars=yes,resizable=no,location=no');} return false;"></a>
                            </div>
                        </div>
                        <div class="card-body">
