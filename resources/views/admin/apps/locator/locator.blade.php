                ...
                <div class="container-fluid px-4 mt-n10">
                    <div class="row">
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card lift lift-sm h-100" href="{{ route('admin_locatorclient') }}">
                        ...
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card lift lift-sm h-100" href="{{ route('admin_locatorbranch') }}">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                        ...
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card lift lift-sm h-100" href="{{ route('admin_locatoremployee') }}">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
