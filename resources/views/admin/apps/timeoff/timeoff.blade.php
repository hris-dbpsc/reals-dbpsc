                        ...
                        <div class="page-header-content pt-4">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto mt-4">
                                    <a href="{{ route('admin_apps') }}" class="btn btn-light rounded-circle shadow-sm d-flex align-items-center justify-content-center" style="width:50px; height:50px; padding:0;">
                ...
                <div class="container-fluid px-4 mt-n10">
                    <div class="row">
                        ...
                        <div class="col-xl-3 mb-2">
                            <!-- CARD 2-->
                            <a class="card lift lift-sm h-100" href="{{ route('admin_alltimeoff') }}?status=all">
                        ...
                        <div class="col-xl-3 mb-2">
                            <!-- CARD 3-->
                            <a class="card lift lift-sm h-100" href="{{ route('admin_alltimeoff') }}?status=pending">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                        ...
                        <div class="col-xl-3 mb-2">
                            <!-- CARD 4-->
                            <a class="card lift lift-sm h-100" href="{{ route('admin_alltimeoff') }}?status=approved">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                        ...
                        <div class="col-xl-3 mb-2">
                            <!-- CARD 4-->
                            <a class="card lift lift-sm h-100" href="{{ route('admin_alltimeoff') }}?status=disapproved">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
