                ...
                <div class="container-fluid px-4 mt-n10">
                    <div class="row">
                        ...
                        <div class="col-xl-4 mb-2">
                            <!-- CARD 1-->
                            <a class="card lift lift-sm h-100" href="{{ route('admin_watsons_allworkforce') }}">
                        ...
                        <div class="col-xl-4 mb-2">
                            <!-- CARD 2-->
                            <a class="card lift lift-sm h-100" href="{{ route('admin_watsons_pendingworkforce') }}">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                        ...
                        <div class="col-xl-4 mb-2">
                            <!-- CARD 3-->
                            <a class="card lift lift-sm h-100" href="{{ route('admin_watsons_completedworkforce') }}">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
