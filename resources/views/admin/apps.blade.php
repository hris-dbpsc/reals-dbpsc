                ...
                <div class="container-fluid px-4 mt-n10">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 mb-4">
                            <a class="card lift h-100 shadow-lg border-0 position-relative" href="{{ route('admin_people') }}">
                        ...
                        <div class="col-xl-3 mb-4">
                            <a class="card lift h-100 shadow-lg border-0 position-relative" href="{{ route('admin_watsonsworkforce') }}">
                                <div class="card-body d-flex justify-content-center flex-column text-center">
                                    <div class="d-flex align-items-center justify-content-center flex-column">
                                        <div class="me-3">
                        ...
                        <div class="col-xl-3 mb-4">
                            <a class="card lift h-100 shadow-lg border-0 position-relative" href="{{ route('admin_timeoff') }}">
                                <div class="card-body d-flex justify-content-center flex-column text-center">
                                    <div class="d-flex align-items-center justify-content-center flex-column">
                                        <div class="me-3">
                        ...
                        <div class="col-xl-3 mb-4">
                            <a class="card lift h-100 shadow-lg border-0 position-relative" href="{{ route('admin_locator') }}">
                                <div class="card-body d-flex justify-content-center flex-column text-center">
                                    <div class="d-flex align-items-center justify-content-center flex-column">
                                        <div class="me-3">
                        ...
                        <div class="col-xl-3 mb-4">
                            <a class="card lift h-100 shadow-lg border-0 position-relative" href="{{ route('admin_timelog') }}">
                                <div class="card-body d-flex justify-content-center flex-column text-center">
                                    <div class="d-flex align-items-center justify-content-center flex-column">
                                        <div class="me-3">
