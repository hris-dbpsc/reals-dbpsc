                                        ...
                                        <table id="datatablesSimple" class="table table-sm table-striped align-middle">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge text-warning">{{ $workforce->status }}</span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-xs" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#editRequestModal{{ $workforce->id }}" title="Edit Request"><i data-feather="edit" style="width:1.5em;height:1.5em;"></i></a>
                                                        @endif
