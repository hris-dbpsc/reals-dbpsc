                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-primary text-white h-100">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-white stretched-link" href="{{ route('clientadmin_useremployee') }}">Employee Management</a>
                        ...
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-warning text-white h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
                                            <div class="text-white-75 small">Branches</div>
                                            <div class="text-lg fw-bold">{{ $branchesCount }}</div>
                                        </div>
                                        <i class="feather-xl text-white-50" data-feather="globe"></i>
                                    </div>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-white stretched-link" href="{{ route('clientadmin_branches') }}">Branch Management</a>
                                    <div class="text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-3 mb-4">
                            <div class="card bg-success text-white h-100">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-white stretched-link" href="{{ route('clientadmin_apps') }}">View Applications</a>
                                    <div class="text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
                                            ...
                                            <div class="text-lg fw-bold">{{ $WatsonsWorkforcePending }}</div>
                                        </div>
                                        <i class="feather-xl text-white-50" data-feather="message-circle"></i>
                                    </div>
                                </div>
                                <div class="card-footer d-flex align-items-center justify-content-between small">
                                    <a class="text-white stretched-link" href="{{ route('clientadmin_watsons_workforce') }}">View Requests</a>
                                    <div class="text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-footer position-relative">
                                    <a class="stretched-link" href="{{ route('clientadmin_watsons_workforce') }}">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-footer position-relative">
                                    <a class="stretched-link" href="{{ route('clientadmin_timeoff') }}">
                                        <div class="text-xs d-flex align-items-center justify-content-between">
                                            View More Data
                                            <i class="fas fa-long-arrow-alt-right"></i>
                                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-xl-2 mb-2">
                                    ...
                                    <a class="card lift h-100" href="{{ route('clientadmin_people') }}">
                                ...
                                <div class="col-xl-2 mb-2">
                                    <!-- Dashboard example card 1-->
                                    <a class="card lift h-100" href="{{ route('clientadmin_watsons_workforce') }}">
                                        <div class="card-body d-flex justify-content-center flex-column">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="me-3">
                                ...
                                <div class="col-xl-2 mb-2">
                                    <!-- Dashboard example card 1-->
                                    <a class="card lift h-100" href="{{ route('clientadmin_timeoff') }}">
                                        <div class="card-body d-flex justify-content-center flex-column">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="me-3">
                                ...
                                <div class="col-xl-2 mb-2">
                                    <!-- Dashboard example card 1-->
                                    <a class="card lift h-100" href="{{ route('clientadmin_locator') }}">
                                        <div class="card-body d-flex justify-content-center flex-column">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="me-3">
                                ...
                                <div class="col-xl-2 mb-2">
                                    <!-- Dashboard example card 1-->
                                    <a class="card lift h-100" href="{{ route('clientadmin_timelog') }}">
                                        <div class="card-body d-flex justify-content-center flex-column">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="me-3">
